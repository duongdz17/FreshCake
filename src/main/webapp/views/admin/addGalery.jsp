...
<title>Thêm mới trưng bày</title>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="row">
						<div class="card">
							<div class="card-body">
								<form action="/FreshCake/add-role" class="row g-3"
									method="post">
									<div class="col-12">
										<label>Mã trưng bày</label> <input type="number" name="id"
											class="form-control" />
									</div>
									<div class="col-12">
									...
									<div class="col-12">
										<label>Mã sản phẩm</label> <input type="number" name="product_id"
											class="form-control" />
									</div>
									<div class="col-12">
