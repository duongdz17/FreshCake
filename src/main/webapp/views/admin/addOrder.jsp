			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="row">
						<div class="card">
							<div class="card-body">
								<form action="/FreshCake/add-order" class="row g-3"
									method="post">
									<div class="col-12">
										<label>Mã order</label> <input type="number" name="id"
											class="form-control" />
									</div>
									<div class="col-12">
									...
									<div class="col-12">
										<label>Ngày order</label> <input type="date"
											name="orderdate" class="form-control" />
									</div>
									<div class="col-12">
