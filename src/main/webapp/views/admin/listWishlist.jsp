...
<body>
		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="mb-3">
						<h1 class="h3 d-inline align-middle">Danh sách Wishlist</h1>
					</div>
					<div class="row">
						<div class="card">
							<div class="card-body">
									...
									<tbody>
										<c:forEach items="${requestScope.wishlists}" var="wishlist">
											<tr>
												...
												<td> <a href="#" onclick="deleteWishlist('${wishlist.id}')"><i
	...
	<script type="text/javascript">
		function deleteWishlist(id) {
			...
			if (answer) {
				window.location = "deleteWishlist?id=" + id;
			}
		}
	</script>
	<script>
