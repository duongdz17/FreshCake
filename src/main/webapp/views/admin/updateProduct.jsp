					...
					<div class="row">
						<div class="card">
							<div class="card-body">
								...
								<form action="/FreshCake/updateProduct" class="row g-3"
									method="post">
									<div class="col-12">
										<label>Mã sản phẩm</label> <input type="number"
											readonly="readonly" name="id" value="${product.id}"
											class="form-control" />
									</div>
									<div class="col-12">
									...
									<div class="col-12">
										<label>Còn kho</label> <input type="number" name="quantity"
									...
									<div class="col-12">
										<label>Sản phẩm nổi bật</label> <input type="number"
											name="is_featured" value="${product.is_featured}"
											class="form-control" />
									</div>
									<div class="col-12">
										<label>Trạng thái</label> <input type="number" name="status"
											value="${product.status}" class="form-control" />
									</div>
									<div class="col-12">
									...
									<div class="col-12">
										<label>Ngày nhập</label> <input type="date" name="create_at"
											value="${product.create_at}" class="form-control" />
									</div>
									<div class="col-12">
										<label>Ngày cập nhật</label> <input type="date"
											name="update_at" value="${product.update_at}"
											class="form-control" />
									</div>
									<div class="col-12">
