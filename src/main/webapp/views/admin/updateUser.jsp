			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="row">
						<div class="card">
							<div class="card-body">
								<h5 class="card-title">Cập nhật thông tin người dùng</h5>
								<c:set var="user" value="${requestScope.user}"></c:set>
								<form action="/FreshCake/updateUser" class="row g-3"
									method="post">
									<div class="col-12">
										<label>Mã người dùng</label> <input type="number"
											readonly="readonly" name="id" value="${user.id}"
											class="form-control" />
									</div>
									<div class="col-12">
									...
									<div class="col-12">
										<label>Số điện thoại</label> <input type="tel"
											name="phonenumber" value="${user.phonenumber}" class="form-control" />
									</div>
									<div class="col-12">
									...
									<div class="col-12">
										<label>Mã quyền</label> <input type="number"
											name="role_id" value="${user.role_id}" class="form-control" />
									</div>
									<div class="col-12">
										<label>Trạng thái</label> <input type="number"
											name="status" value="${user.status}" class="form-control" />
									</div>
									<div class="col-12">
