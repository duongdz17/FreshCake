<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%
	if(session.getAttribute("adminrobj") == null){
		response.sendRedirect("/FreshCake/views/admin/loginAdmin.jsp");
	}
%>
		...
		<ul class="navbar-nav navbar-align">
				...
				<div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0"
					...
					<div class="list-group">
						<a href="#" class="list-group-item">
							<div class="row g-0 align-items-center">
								<div class="col-2">
									<img src="${url}/img/avatars/avatar-5.jpg"
							...
							<div class="row g-0 align-items-center">
								<div class="col-2">
									<img src="${url}/img/avatars/avatar-2.jpg"
							...
							<div class="row g-0 align-items-center">
								<div class="col-2">
									<img src="${url}/img/avatars/avatar-4.jpg"
							...
							<div class="row g-0 align-items-center">
								<div class="col-2">
									<img src="${url}/img/avatars/avatar-3.jpg"
			...
			<li class="nav-item dropdown"><a
				...
				href="#" data-bs-toggle="dropdown"> <img
					src="${url}/img/avatars/avatar.jpg"
					class="avatar img-fluid rounded me-1" alt="Charles Hall" /> <span
					class="text-dark">Huy Cao</span>
			</a>
