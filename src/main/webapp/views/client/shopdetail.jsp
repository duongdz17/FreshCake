                ...
                <div class="col-lg-6">
                    <div class="product__details__img">
                        <div class="product__details__big__img">
                            <img class="big_img" src="${url}/img/shop/<%=product.getThumbnail()%>" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="product__details__text">
                        <div class="product__label"><%=product.getCategory_id() %></div>
                        <h4><%=product.getName() %></h4>
                        <h5><%=product.getPrice() %>VND</h5>
                        <p><%=product.getDescription() %></p>
                        <ul>
                            <li>Mã bánh: <span><%=product.getId() %></span></li>
                        ...
                        <div class="product__details__option">
                            ...
                            <%
								if (user == null) {
								%>
								<a href="loginUser.jsp" class="primary-btn">Add to cart</a>
								<%
								} else {
								%>
								<a href="../../add-to-cart?id=<%=product.getId() %>" class="primary-btn">Add to cart</a>
								<%
								}
								%>
                ...
                <div class="related__products__slider owl-carousel">
                    <div class="col-lg-3">
                        <div class="product__item">
                            <div class="product__item__pic set-bg" data-setbg="${url}/img/shop/product-1.jpg">
                    ...
                    <div class="col-lg-3">
                        <div class="product__item">
                            <div class="product__item__pic set-bg" data-setbg="${url}/img/shop/product-2.jpg">
                                <div class="product__label">
                                    <span>Cupcake</span>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3">
                        <div class="product__item">
                            <div class="product__item__pic set-bg" data-setbg="${url}/img/shop/product-3.jpg">
                                <div class="product__label">
                                    <span>Cupcake</span>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3">
                        <div class="product__item">
                            <div class="product__item__pic set-bg" data-setbg="${url}/img/shop/product-4.jpg">
                                <div class="product__label">
                                    <span>Cupcake</span>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3">
                        <div class="product__item">
                            <div class="product__item__pic set-bg" data-setbg="${url}/img/shop/product-5.jpg">
                                <div class="product__label">
                                    <span>Cupcake</span>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3">
                        <div class="product__item">
                            <div class="product__item__pic set-bg" data-setbg="${url}/img/shop/product-6.jpg">
                                <div class="product__label">
                                    <span>Cupcake</span>
                                </div>
                            </div>
