...
<%
    ...
    List<Product> products = productDAO.getProductSearch(search);
	%>
<%
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="product__item">
						...
						<div class="product__item__text">
							...
							<div class="cart_add">
								<a href="../../add-to-cart?id=<%=product.getId() %>">Add to cart</a>|<a href="shopdetail.jsp?id=<%=product.getId()%>">Shop Detail</a> 
							</div>
						</div>
					</div>
				</div>
